...
# L’API est exposée sur le port 8000 dans le conteneur.
...
Docker Compose est utilisé pour l'environnement local avec PostgreSQL.

Kubernetes est utilisé pour le déploiement avec plusieurs réplicas de l'API.
